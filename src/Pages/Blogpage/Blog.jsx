        ...
        <div className="container">
            <div className="text-left">
                ...
                <div className="flex justify-center items-center mt-[32px]">
                    <button className="py-3 px-5 text-4 text-[#696A75] font-medium border-[1px] border-[#696A75] outline-0 rounded-[6px] capitalize cursor-pointer">View All Post</button>
                </div>
            </div>
        </div>
    </div>
